# Modelisation evaporation film eau pure par differences finies
# Niveau liquide variable -> immobilisation de la frontière
# Comparaison avec profil quasi-stationnaire, voir "Pn_Arnold_Fini_1b.py"
# Comparaison avec resultats experimentaux
# RH, 29/03/25

import xlrd    #necessaire pour lire du EXEL
